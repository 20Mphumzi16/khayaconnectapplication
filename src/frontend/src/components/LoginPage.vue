<template>
  <div class="app-container">
    <h1 class="title">Welcome to Khaya-Connect</h1>
    <p class="subtitle">Sign in or create an account to access unlimited service.</p>
...
export default {
  ...
  methods: {
    async login() {
      ...
      const url = 'http://localhost:8080/khayaconnection/auth/login';
